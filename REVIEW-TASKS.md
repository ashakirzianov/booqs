...
- [x] **P4. Improve EPUB file caching** — replaced single-entry `cachedFile` variable with `LRUCache` (max 10 entries). `lru-cache` was already installed as a transitive dependency.
