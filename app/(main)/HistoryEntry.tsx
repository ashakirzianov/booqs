...
function BooqPreview({
    ...
    return (
        <div className="flex flex-col grow shrink-0 basis-auto w-[90vw] rounded-sm items-center font-book text-lg cursor-pointer px-8 p-4 max-w-[400px] border border-border shadow transition-shadow hover:shadow-lg">
